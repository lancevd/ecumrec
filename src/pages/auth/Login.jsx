...
export default function Login() {
  return (
    <div className="w-full max-w-md mx-auto bg-white rounded-xl shadow p-8 mt-8">
      ...
      <h2 className="text-2xl font-bold text-center mb-6 text-[#184C85]">Sign in to your account</h2>
      <form className="space-y-5">
        ...
        <button type="submit" className="w-full py-2 px-4 bg-[#184C85] text-white rounded-lg font-semibold hover:bg-[#123a69] transition">Sign in</button>
        <div className="flex justify-between mt-2 text-sm">
          <Link to="/register" className="text-[#184C85] hover:underline">Create account</Link>
          <Link to="/forgot-password" className="text-[#184C85] hover:underline">Forgot password?</Link>
        </div>
      </form>
    </div>
  );
